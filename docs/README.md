...
This directory contains comprehensive technical documentation optimized for AI coding assistants working with the
yii2-gii-mcp project.
...
**Use Case**: AI agents should refer to this document as their primary source of technical information about the
project. It contains everything needed to understand, use, and extend the yii2-gii-mcp server.
